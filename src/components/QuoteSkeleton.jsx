const QuoteSkeleton = () => {
  return (
    <div className="p-6 w-[150%] bg-gradient-to-br from-blue-100/80 via-indigo-100/80 to-purple-100/80 rounded-xl shadow-xl border border-indigo-200 backdrop-blur-md animate-pulse space-y-3">
